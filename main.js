...
conn.sSubject = '*Se ha cambiado el nombre del grupo a:* @subject'
conn.sIcon = '*¡Se siente la frescura! Se ha cambiado la foto del grupo.*'
conn.sRevoke = '*¡Hay nuevo link para el grupo! Es este:* @revoke'
