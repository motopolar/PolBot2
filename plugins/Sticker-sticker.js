...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 8) return m.reply('🤪 ¡Woooow! Eso dura demasiado, si lo recortaras a una duración menor a 7 segundos te lo agradecería.')
