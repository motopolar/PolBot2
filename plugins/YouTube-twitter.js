...
if (!text) throw `💢💢💢 ¡Mete un enlace después del comando!`;
 try {
 ...
 try {
   ...
   try {
     ...
     await conn.sendFile(m.chat, AA.url[0].url, 'error.mp4', '😘 ¡Aquí tienes _cari_!', m);
   } catch {
     throw '😥 Chanfles, no he podido descargarlo. Inténtalo de nuevo.';
   }
  }
 }
};    
